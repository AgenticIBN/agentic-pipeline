...
INSTRUCTIONS = [
    ...
    "",
    "⚠️  **CRITICAL: ALWAYS include ALL KPIs in expected_kpis, especially ENERGY_WATT!**",
    "",
    "**Required KPIs (MUST all be present):**",
    "- RX_POWER (dBm)",
    "- SINR (dB)", 
    "- COVERAGE (0-1)",
    "- THROUGHPUT_5P (Mbps)",
    "- LOAD_IMBALANCE (0-100)",
    "- **ENERGY_WATT (Watts) ← DO NOT FORGET!**",
    "",
    "```",
    ...
    "                = -67.1 dBm",
    "",
    "Example: ENERGY_WATT prediction",
    "",
    "Intent A (weight=0.6): Expected ENERGY_WATT = 70.19 W",
    "Intent B (weight=0.4): Expected ENERGY_WATT = 55.75 W",
    "",
    "Merged ENERGY_WATT = (70.19 × 0.6) + (55.75 × 0.4)",
    "                   = 42.11 + 22.30",
    "                   = 64.41 W",
    "```",
    "",
    ...
    '    "expected_kpis": {',
    '      "RX_POWER": <merged_value>,',
    '      "SINR": <merged_value>,',
    '      "COVERAGE": <merged_value>,',
    '      "THROUGHPUT_5P": <merged_value>,',
    '      "LOAD_IMBALANCE": <merged_value>,',
    '      "ENERGY_WATT": <merged_value>  ← REQUIRED!',
    '    },',
